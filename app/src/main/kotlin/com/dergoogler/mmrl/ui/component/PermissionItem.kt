...
private fun getPermissionDetails(id: String): Permission? {
    val permissionMap =
        mapOf(
            ...
            "kernelsu.permission.POST_MOUNT" to
                Permission(
            ...
            "kernelsu.permission.BOOT_COMPLETED" to
                Permission(
