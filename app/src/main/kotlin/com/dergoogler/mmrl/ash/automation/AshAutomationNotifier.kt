...
class AshAutomationNotifier(private val context: Context) {
    ...
    private fun buildNotification(signal: AshAlertSignal) =
        NotificationCompat.Builder(context, NotificationUtils.CHANNEL_ID_ASH_RECOVERY)
            ...
            .addAction(R.drawable.box, context.getString(R.string.recovery_open_center), openRecoveryIntent(signal.kind.notificationId + 100))
            .addAction(R.drawable.box, context.getString(R.string.boot_protection_check_now), recheckIntent(signal.kind.notificationId + 200))
            .setAutoCancel(true)
    ...
    private fun buildRecoveryClearedNotification() =
        NotificationCompat.Builder(context, NotificationUtils.CHANNEL_ID_ASH_RECOVERY)
            .setSmallIcon(R.drawable.box)
            .setContentTitle(context.getString(R.string.ash_alert_stable_title))
            .setContentText(context.getString(R.string.ash_alert_stable_message))
